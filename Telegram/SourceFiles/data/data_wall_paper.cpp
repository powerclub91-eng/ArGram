...
WallPaper WallPaper::ConstructDefault() {
	// ArGram Galaxy Animated Background
	auto result = WallPaper(
		kDefaultBackground
	).withPatternIntensity(50).withBackgroundColors({
		QColor(0,   212, 255),  // cyan   #00D4FF
		QColor(123,  47, 255),  // violet #7B2FFF
		QColor(204,   0, 255),  // magenta #CC00FF
		QColor(13,   13,  26),  // dark   #0D0D1A
	});
